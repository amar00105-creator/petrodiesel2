...
<body>
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="fw-bold fs-2" style="color: var(--primary);">لوحة المبيعات</h1>
                <p class="text-muted">إدارة عمليات البيع والورديات</p>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-2 col-6">
                <a href="<?= BASE_URL ?>/sales/create?type=cash" class="card h-100 text-decoration-none shadow-sm border-0 hover-lift">
                    <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="icon-circle bg-success bg-opacity-10 text-success mb-2">
                            <i class="fas fa-money-bill-wave fa-lg"></i>
                        </div>
                        <h6 class="text-dark fw-bold mb-0">بيع نقدي</h6>
                    </div>
                </a>
            </div>
            <!-- Credit Sale -->
            <div class="col-md-2 col-6">
                <a href="<?= BASE_URL ?>/sales/create?type=credit" class="card h-100 text-decoration-none shadow-sm border-0 hover-lift">
                    <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="icon-circle bg-warning bg-opacity-10 text-warning mb-2">
                            <i class="fas fa-file-invoice-dollar fa-lg"></i>
                        </div>
                        <h6 class="text-dark fw-bold mb-0">بيع آجل</h6>
                    </div>
                </a>
            </div>
            <!-- Sales Report -->
            <div class="col-md-2 col-6">
                <a href="<?= BASE_URL ?>/sales/reports" class="card h-100 text-decoration-none shadow-sm border-0 hover-lift">
                    <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="icon-circle bg-info bg-opacity-10 text-info mb-2">
                            <i class="fas fa-chart-line fa-lg"></i>
                        </div>
                        <h6 class="text-dark fw-bold mb-0">تقرير المبيعات</h6>
                    </div>
                </a>
            </div>
            <!-- Counters -->
            <div class="col-md-2 col-6">
                <a href="<?= BASE_URL ?>/counters" class="card h-100 text-decoration-none shadow-sm border-0 hover-lift">
                    <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="icon-circle bg-primary bg-opacity-10 text-primary mb-2">
                            <i class="fas fa-tachometer-alt fa-lg"></i>
                        </div>
                        <h6 class="text-dark fw-bold mb-0">العدادات</h6>
                    </div>
                </a>
            </div>
            <!-- Add Customer -->
            <div class="col-md-2 col-6">
                <a href="<?= BASE_URL ?>/sales/customers/create" class="card h-100 text-decoration-none shadow-sm border-0 hover-lift">
                    <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="icon-circle bg-secondary bg-opacity-10 text-secondary mb-2">
                            <i class="fas fa-user-plus fa-lg"></i>
                        </div>
                        <h6 class="text-dark fw-bold mb-0">اضافة زبون</h6>
                    </div>
                </a>
            </div>
            <!-- Pumps -->
            <div class="col-md-2 col-6">
                <a href="<?= BASE_URL ?>/pumps" class="card h-100 text-decoration-none shadow-sm border-0 hover-lift">
                    <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="icon-circle bg-danger bg-opacity-10 text-danger mb-2">
                            <i class="fas fa-gas-pump fa-lg"></i>
                        </div>
                        <h6 class="text-dark fw-bold mb-0">الطرمبات</h6>
                    </div>
                </a>
            </div>
        </div>
