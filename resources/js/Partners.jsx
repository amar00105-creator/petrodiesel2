        ...
        <div className="p-6 max-w-[1800px] mx-auto min-h-screen space-y-8 animate-fade-in">
            ...
            <div className="space-y-6">
                <TabGroup index={selectedIndex} onIndexChange={setSelectedIndex}>
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-2 rounded-2xl shadow-sm border border-slate-100 mb-6 dark:bg-white/5 dark:backdrop-blur-md dark:border-white/10 dark:shadow-none">
                        {/* Right Side: Tabs (RTL) */}
                        <div className="w-full md:w-auto flex justify-center md:justify-start">
                            <TabList variant="solid" className="bg-slate-50 p-1 rounded-xl shadow-inner border border-slate-200/50 dark:bg-white/5 dark:border-white/5">
                                <Tab className="px-6 py-2 rounded-lg font-bold text-slate-500 ui-selected:bg-blue-600 ui-selected:text-white ui-selected:shadow-md transition-all dark:text-slate-400 dark:ui-selected:text-white dark:ui-selected:shadow-none">
                                    <div className="flex items-center gap-2">
                                        <Truck className="w-4 h-4"/>
                                        <span>الموردين</span>
                                    </div>
                                </Tab>
                                <Tab className="px-6 py-2 rounded-lg font-bold text-slate-500 ui-selected:bg-indigo-600 ui-selected:text-white ui-selected:shadow-md transition-all dark:text-slate-400 dark:ui-selected:text-white dark:ui-selected:shadow-none">
                                    <div className="flex items-center gap-2">
