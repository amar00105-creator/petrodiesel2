...
// import AccountingDashboard from './AccountingDashboard'; // STATIC IMPORT TO FIX CRASH
const AccountingDashboard = () => <div className="p-10 m-10 bg-green-500 text-white font-bold text-4xl">INLINED COMPONENT WORKS - FILE SYSTEM ISSUE</div>;
