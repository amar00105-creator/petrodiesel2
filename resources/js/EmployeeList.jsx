...
const EmployeeList = forwardRef(({ employees = [], search = '' }, ref) => {
    ...
    // Lifted search state, using prop instead
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start mb-3">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-bold text-lg">
                                    {emp.name.charAt(0)}
                                </div>
                                <div>
                                    <h3 className="font-bold text-navy-900 dark:text-white">{emp.name}</h3>
                        ...
                        <div className="flex items-center justify-between text-sm mt-4 pt-4 border-t border-slate-50 dark:border-white/5">
                            ...
                            <span className="text-xs text-slate-400 dark:text-slate-500">ID: {emp.id}</span>
                        </div>
                    </motion.div>
                ))}
            </div>
