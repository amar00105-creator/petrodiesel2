                    ...
                    <form action="<?= BASE_URL ?>/sales/store" method="POST" id="salesForm">
                        ...
                        <div class="mb-4 p-3 rounded" style="background: rgba(0,0,0,0.03);">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="text-muted mb-1">العامل المسؤول</h6>
                                    <h5 class="fw-bold mb-0 text-dark" id="worker_display">--</h5>
                                    <input type="hidden" name="worker_id" id="worker_id">
                                </div>
                                <div class="text-end">
                                    <h6 class="text-muted mb-1">نوع الوقود</h6>
                                    <span class="badge bg-primary" id="product_type_badge">--</span>
                                </div>
                            </div>
                        </div>
                ...
                fetch(`<?= BASE_URL ?>/sales/getCounterDetails?counter_id=${counterId}`)
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            workerDisplay.textContent = data.worker_name;
